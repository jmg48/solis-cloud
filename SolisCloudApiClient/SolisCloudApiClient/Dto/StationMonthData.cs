...
{
    internal record StationMonthData(string Id, double Money, string MoneyStr, string MoneyPec, double Energy, string EnergyStr, string EnergyPec, double FullHour,
